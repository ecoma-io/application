...
- Thiết kế nghiệp vụ
  ...
  - Feature Bounded Contexts
    - Value stream
      ...
      - [Payment Processing Management](/domain-design/feature/value-stream/ppm.md)
...
- Thiết kế kĩ thuật
  ...
  - Feature Bounded Contexts
    - Value stream
      ...
      - [Payment Processing Management](/domain-implement/feature/value-stream/ppm-implement.md)
