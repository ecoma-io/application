...
{ boundedContext: 1 }               // Tìm policies theo BC
{ tenantId: 1 }                     // Tìm policies theo tenant
{ actionType: 1 }                   // Tìm policies theo actionType
{ entityType: 1 }                   // Tìm policies theo entityType
```
