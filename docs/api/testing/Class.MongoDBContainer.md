...
> **start**(): `Promise`\<[`StartedMongoDBContainer`](/api/testing/Class.StartedMongoDBContainer.md)\>

#### Returns

`Promise`\<[`StartedMongoDBContainer`](/api/testing/Class.StartedMongoDBContainer.md)\>
