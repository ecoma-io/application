...
> **start**(): `Promise`\<[`StartedPostgresContainer`](/api/testing/Class.StartedPostgresContainer.md)\>

Khởi động container và trả về instance StartedPostgresContainer

#### Returns

`Promise`\<[`StartedPostgresContainer`](/api/testing/Class.StartedPostgresContainer.md)\>
