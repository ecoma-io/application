...
> **start**(): `Promise`\<[`StartedRedisContainer`](/api/testing/Class.StartedRedisContainer.md)\>

#### Returns

`Promise`\<[`StartedRedisContainer`](/api/testing/Class.StartedRedisContainer.md)\>
