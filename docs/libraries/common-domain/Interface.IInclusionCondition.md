...
> **operator**: [`InclusionOperator`](/libraries/common-domain/TypeAlias.InclusionOperator.md)
...
> **value**: [`Nullable`](/libraries/common-domain/TypeAlias.Nullable.md)\<`Primitive`\>[]
