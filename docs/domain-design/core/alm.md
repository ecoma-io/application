...
- **RetentionPolicy:**
  ...
  - **Version:** Số version của policy (hỗ trợ versioning/audit).
...
- **ALM-UC-8.4.1: Tạo mới Retention Policy**
  ...
  - **Mô tả:** Actor gửi yêu cầu tạo policy, Application Service kiểm tra quyền, validate dữ liệu, tạo RetentionPolicy AR và lưu vào database.
...
- **ALM-UC-8.4.2: Cập nhật Retention Policy**
  ...
  - **Mô tả:** Actor gửi yêu cầu cập nhật, Application Service kiểm tra quyền, validate, cập nhật AR, lưu lại version mới, ghi audit.
...
- **ALM-UC-8.4.3: Xóa Retention Policy**
  ...
  - **Mô tả:** Actor gửi yêu cầu xóa, Application Service kiểm tra quyền, validate, xóa AR khỏi database, ghi audit.
...
- **ALM-UC-8.4.4: Kích hoạt/Vô hiệu hóa Retention Policy**
  ...
  - **Mô tả:** Actor gửi yêu cầu, Application Service cập nhật trạng thái isActive của policy.

- **ALM-UC-8.4.5: Xem danh sách/chi tiết Retention Policy**
  - **Loại:** Query
  - **Actor:** Quản trị viên hệ thống
  - **Mục đích:** Lấy danh sách hoặc chi tiết policy để quản lý.
  - **Mô tả:** Actor gửi query, Application Service truy vấn database, trả về thông tin policy.
