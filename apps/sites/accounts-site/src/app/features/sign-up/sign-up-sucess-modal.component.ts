...
@Component({
  ...
  template: `
    ...
    >
      <nge-icon class="fill-success h-24 w-24" path="duotone/envelope.svg" />
...
export class SignUpSuccessModalComponent {
  protected readonly title = "Registration successful!";
  protected readonly message =
    "We have sent you a confirmation email. Check your inbox and start your journey with ecoma";
  protected readonly action = "Got it";
