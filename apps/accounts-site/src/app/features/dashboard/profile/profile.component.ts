          ...
          <form [formGroup]="profileForm" (ngSubmit)="onSubmit()" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="form-control">
                ...
                <div class="relative">
                  <nge-svg-injector
                    [path]="iconUrl('/duotone/user.svg')"
                    class="h-4 w-4 absolute left-3 top-1/2 -translate-y-1/2 text-base-content/50"
                  >
                  </nge-svg-injector>
                  <input
                    type="text"
              ...
              <div class="form-control">
                ...
                <div class="relative">
                  <nge-svg-injector
                    [path]="iconUrl('/duotone/phone.svg')"
                    class="h-4 w-4 absolute left-3 top-1/2 -translate-y-1/2 text-base-content/50"
                  >
                  </nge-svg-injector>
                  <input
...
export class ProfileComponent {
  ...
  constructor(private fb: FormBuilder, private title: Title, private domain: Domains) {
